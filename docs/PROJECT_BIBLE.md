...
- bbox는 글리프 윤곽·클리핑 영역·정확한 잉크 경계가 아닌 근사 축 정렬 사각형이다. 회전·반사 transform의 네 모서리 계산은 검증했지만 실제 화면과 sourceIndex별 시각 대조는 Unit 2.5 Debug Overlay에 남긴다. Unit 2.3 키워드 후보는 bbox를 사용하지 않으며 줄의 시각 위치·블록·영역 의미는 계산하지 않는다.
