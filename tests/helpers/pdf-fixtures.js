...
/** One single-column question with solution then answer region headings. */
export function regionPdf() {
  const content = [
    'BT',
    '/F1 12 Tf',
    '1 0 0 1 25 260 Tm',
    '(Question 1. Choose the correct option.) Tj',
    '0 -28 Td',
    '(A. first choice   B. second choice) Tj',
    '0 -28 Td',
    '(Solution: apply the stated rule.) Tj',
    '0 -28 Td',
    '(Continue the reasoning to the result.) Tj',
    '0 -28 Td',
    '(Answer: B) Tj',
    'ET',
    '',
